 ...
 * Stub hash: 169d293a87a0b08aa0bab0b6ff26dd2867948ab8 */
...
#define arginfo_class_ArrayBuffer___serialize arginfo_class_ArrayBuffer_serialize

#define arginfo_class_ArrayBuffer___unserialize arginfo_class_ArrayBuffer_unserialize
...
#define arginfo_class_TypedArray___wakeup arginfo_class_ArrayBuffer_serialize

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_TypedArray_offsetGet, 0, 0, 1)
	ZEND_ARG_INFO(0, offset)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_TypedArray_offsetSet, 0, 0, 2)
	ZEND_ARG_INFO(0, offset)
	ZEND_ARG_INFO(0, value)
ZEND_END_ARG_INFO()

#define arginfo_class_TypedArray_offsetExists arginfo_class_TypedArray_offsetGet

#define arginfo_class_TypedArray_offsetUnset arginfo_class_TypedArray_offsetGet

#define arginfo_class_TypedArray_rewind arginfo_class_ArrayBuffer_serialize

#define arginfo_class_TypedArray_next arginfo_class_ArrayBuffer_serialize

#define arginfo_class_TypedArray_valid arginfo_class_ArrayBuffer_serialize

#define arginfo_class_TypedArray_key arginfo_class_ArrayBuffer_serialize

#define arginfo_class_TypedArray_current arginfo_class_ArrayBuffer_serialize

#define arginfo_class_TypedArray___serialize arginfo_class_ArrayBuffer_serialize

#define arginfo_class_TypedArray___unserialize arginfo_class_ArrayBuffer_unserialize

#define arginfo_class_Int8Array_offsetGet arginfo_class_TypedArray_offsetGet

#define arginfo_class_Int8Array_current arginfo_class_ArrayBuffer_serialize

#define arginfo_class_UInt8Array_offsetGet arginfo_class_TypedArray_offsetGet

#define arginfo_class_UInt8Array_current arginfo_class_ArrayBuffer_serialize

#define arginfo_class_Int16Array_offsetGet arginfo_class_TypedArray_offsetGet

#define arginfo_class_Int16Array_current arginfo_class_ArrayBuffer_serialize

#define arginfo_class_UInt16Array_offsetGet arginfo_class_TypedArray_offsetGet

#define arginfo_class_UInt16Array_current arginfo_class_ArrayBuffer_serialize

#define arginfo_class_Int32Array_offsetGet arginfo_class_TypedArray_offsetGet

#define arginfo_class_Int32Array_current arginfo_class_ArrayBuffer_serialize

#define arginfo_class_FloatArray_offsetGet arginfo_class_TypedArray_offsetGet

#define arginfo_class_FloatArray_current arginfo_class_ArrayBuffer_serialize

#define arginfo_class_DoubleArray_offsetGet arginfo_class_TypedArray_offsetGet
